...
I have written the code in python programming languages. I have read the data stored on local device in "csv" format. All the csv files 
will be available when you unzip the file.

Plugins and Dependencies::

In my programs i have used only two python library named "pandas" and "numpy".

I have given codes in ".py" format and scripts corresponding to code in ".sh" format. please use any of them if anyone is not compatible.
